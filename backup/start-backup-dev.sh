...
-v $host_logs:$rails_root/backup/log \
...
jvlythical/cde-backup:dev sh -c "groupadd $docker_group -g $docker_gid; usermod -aG $docker_group www-data; /sbin/run.sh; rake backup['Init']"
