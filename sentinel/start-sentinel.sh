...
jvlythical/cde-sentinel:0.2.0a sh -c "groupadd $docker_group -g $docker_gid; usermod -aG $docker_group www-data; bundle exec whenever -w; service cron restart; /bin/bash"
